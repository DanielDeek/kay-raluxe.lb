import { HeartHandshake, MessageCircle, PackageCheck, Sparkles } from "lucide-react";
...
const BENEFITS = [
  ...
  { icon: MessageCircle, title: "WhatsApp assistance", text: "A real person to answer your questions." },
];
          ...
          <div className="grid gap-x-8 gap-y-8 sm:grid-cols-2 sm:gap-y-10">
            {BENEFITS.map(({ icon: Icon, title, text }) => (
              <div key={title} data-gsap-reveal className="border-t border-charcoal/15 pt-4">
                <Icon className="h-5 w-5 text-mutedBrown" strokeWidth={1.5} />
